...
class CustonDiscordClient (Client):
    ...
    async def on_message(self, message: Message):
        ...
        if bot_caller in  message_content:
            ...
            print(f"_____________ Prompt message: {prompt} _____________")
...
custom_discord_client: CustonDiscordClient = CustonDiscordClient(intents=intents)
